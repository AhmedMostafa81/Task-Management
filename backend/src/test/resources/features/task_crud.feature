Feature: Task Lifecycle and Editing
  ...
  Scenario: Create a new task
    ...
    When I create a task titled "Submit Internship Assignment" with priority "HIGH" and status "TODO" and user "testuser"
  ...
  Scenario: Move a task from TODO to IN_PROGRESS
    Given I have an existing task titled "Write Backend Tests" with status "TODO" and priority "MEDIUM" and user "testuser"
  ...
  Scenario: Increase task priority when deadline is close
    Given I have an existing task titled "Fix Database Config" with status "TODO" and priority "LOW" and user "testuser"
  ...
  Scenario: Delete a task after completion
    Given I have an existing task titled "Old Setup Task" with status "DONE" and priority "LOW" and user "testuser"
